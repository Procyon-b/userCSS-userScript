// ==UserScript==
// @name         Return YouTube Dislike - Modified
// @namespace    https://github.com/Procyon-b/
// @originalHomepage     https://www.returnyoutubedislike.com/
// @version      3.1.1
// @encoding     utf-8
...
// @compatible   safari
// @compatible   edge
// @originalDownloadURL  https://github.com/Anarios/return-youtube-dislike/raw/main/Extensions/UserScript/Return%20Youtube%20Dislike.user.js
// @originalUpdateURL    https://github.com/Anarios/return-youtube-dislike/raw/main/Extensions/UserScript/Return%20Youtube%20Dislike.user.js
...
function getButtons() {
  ...
  if (document.getElementById("menu-container")?.offsetParent === null) {
    return (
      document.querySelector('ytd-segmented-like-dislike-button-renderer yt-smartimation.ytd-segmented-like-dislike-button-renderer') ??
...
function getLikeButton() {
  return getButtons().children[0].tagName ===
    ...
    : getButtons().children[0].id === 'segmented-buttons-wrapper'
     ? getButtons().children[0].children[0]
